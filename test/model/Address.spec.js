...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.Address();
  });
  ...
  describe('Address', function() {
    it('should create an instance of Address', function() {
      ...
      //var instane = new WealthsimpleApi.Address();
      //expect(instance).to.be.a(WealthsimpleApi.Address);
    });
    ...
    it('should have the property provinceStateRegion (base name: "province_state_region")', function() {
      // uncomment below and update the code to test the property provinceStateRegion
      //var instane = new WealthsimpleApi.Address();
      //expect(instance).to.be();
    });
