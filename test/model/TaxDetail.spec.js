...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.TaxDetail();
  });
  ...
  describe('TaxDetail', function() {
    it('should create an instance of TaxDetail', function() {
      // uncomment below and update the code to test TaxDetail
      //var instane = new WealthsimpleApi.TaxDetail();
      //expect(instance).to.be.a(WealthsimpleApi.TaxDetail);
    });
    ...
    it('should have the property baseGrossAmount (base name: "base_gross_amount")', function() {
      // uncomment below and update the code to test the property baseGrossAmount
      //var instane = new WealthsimpleApi.TaxDetail();
      //expect(instance).to.be();
    });

    it('should have the property excessGrossAmount (base name: "excess_gross_amount")', function() {
      // uncomment below and update the code to test the property excessGrossAmount
      //var instane = new WealthsimpleApi.TaxDetail();
      //expect(instance).to.be();
    });
    ...
    it('should have the property taxOverridePercentage (base name: "tax_override_percentage")', function() {
      // uncomment below and update the code to test the property taxOverridePercentage
      //var instane = new WealthsimpleApi.TaxDetail();
      //expect(instance).to.be();
    });

    it('should have the property federalTaxAmount (base name: "federal_tax_amount")', function() {
      // uncomment below and update the code to test the property federalTaxAmount
      //var instane = new WealthsimpleApi.TaxDetail();
      //expect(instance).to.be();
    });

    it('should have the property federalTaxPercentage (base name: "federal_tax_percentage")', function() {
      // uncomment below and update the code to test the property federalTaxPercentage
      //var instane = new WealthsimpleApi.TaxDetail();
      //expect(instance).to.be();
    });

    it('should have the property provincialTaxAmount (base name: "provincial_tax_amount")', function() {
      // uncomment below and update the code to test the property provincialTaxAmount
      //var instane = new WealthsimpleApi.TaxDetail();
      //expect(instance).to.be();
    });

    it('should have the property provincialTaxPercentage (base name: "provincial_tax_percentage")', function() {
      // uncomment below and update the code to test the property provincialTaxPercentage
      //var instane = new WealthsimpleApi.TaxDetail();
      //expect(instance).to.be();
    });
    ...
    it('should have the property personOrSpouseAge (base name: "person_or_spouse_age")', function() {
      // uncomment below and update the code to test the property personOrSpouseAge
      //var instane = new WealthsimpleApi.TaxDetail();
      //expect(instance).to.be();
    });

    it('should have the property accountMarketValue (base name: "account_market_value")', function() {
      // uncomment below and update the code to test the property accountMarketValue
      //var instane = new WealthsimpleApi.TaxDetail();
      //expect(instance).to.be();
    });

    it('should have the property accountMarketValuePreviousYear (base name: "account_market_value_previous_year")', function() {
      // uncomment below and update the code to test the property accountMarketValuePreviousYear
      //var instane = new WealthsimpleApi.TaxDetail();
      //expect(instance).to.be();
    });
