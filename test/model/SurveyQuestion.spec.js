...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.SurveyQuestion();
  });
  ...
  describe('SurveyQuestion', function() {
    it('should create an instance of SurveyQuestion', function() {
      ...
      //var instane = new WealthsimpleApi.SurveyQuestion();
      //expect(instance).to.be.a(WealthsimpleApi.SurveyQuestion);
    });
    ...
    it('should have the property rangeLimits (base name: "range_limits")', function() {
      // uncomment below and update the code to test the property rangeLimits
      //var instane = new WealthsimpleApi.SurveyQuestion();
      //expect(instance).to.be();
    });
    ...
    it('should have the property subtext (base name: "subtext")', function() {
      // uncomment below and update the code to test the property subtext
      //var instane = new WealthsimpleApi.SurveyQuestion();
      //expect(instance).to.be();
    });
    ...
    it('should have the property inlineContext (base name: "inline_context")', function() {
    ...
    it('should have the property parentQuestion (base name: "parent_question")', function() {
      // uncomment below and update the code to test the property parentQuestion
      //var instane = new WealthsimpleApi.SurveyQuestion();
      //expect(instance).to.be();
    });
