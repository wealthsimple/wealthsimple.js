...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.Withdrawal();
  });
  ...
  describe('Withdrawal', function() {
    it('should create an instance of Withdrawal', function() {
      ...
      //var instane = new WealthsimpleApi.Withdrawal();
      //expect(instance).to.be.a(WealthsimpleApi.Withdrawal);
    });
    ...
    it('should have the property fundsTransferScheduleId (base name: "funds_transfer_schedule_id")', function() {
      // uncomment below and update the code to test the property fundsTransferScheduleId
      //var instane = new WealthsimpleApi.Withdrawal();
      //expect(instance).to.be();
    });
    ...
    it('should have the property withdrawalReason (base name: "withdrawal_reason")', function() {
      // uncomment below and update the code to test the property withdrawalReason
      //var instane = new WealthsimpleApi.Withdrawal();
      //expect(instance).to.be();
    });

    it('should have the property taxDetail (base name: "tax_detail")', function() {
      // uncomment below and update the code to test the property taxDetail
      //var instane = new WealthsimpleApi.Withdrawal();
      //expect(instance).to.be();
    });
