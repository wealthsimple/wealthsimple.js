...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.CorporationBase();
  });
  ...
  describe('CorporationBase', function() {
    it('should create an instance of CorporationBase', function() {
      // uncomment below and update the code to test CorporationBase
      //var instane = new WealthsimpleApi.CorporationBase();
      //expect(instance).to.be.a(WealthsimpleApi.CorporationBase);
    });
    ...
    it('should have the property taxIdentificationNumber (base name: "tax_identification_number")', function() {
      // uncomment below and update the code to test the property taxIdentificationNumber
      //var instane = new WealthsimpleApi.CorporationBase();
      //expect(instance).to.be();
    });
