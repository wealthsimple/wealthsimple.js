...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.SurveyState();
  });
  ...
  describe('SurveyState', function() {
    it('should create an instance of SurveyState', function() {
      // uncomment below and update the code to test SurveyState
      //var instane = new WealthsimpleApi.SurveyState();
      //expect(instance).to.be.a(WealthsimpleApi.SurveyState);
    });
    ...
    it('should have the property answerOptions (base name: "answer_options")', function() {
      // uncomment below and update the code to test the property answerOptions
      //var instane = new WealthsimpleApi.SurveyState();
      //expect(instance).to.be();
    });
