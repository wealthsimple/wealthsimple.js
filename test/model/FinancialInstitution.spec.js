...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.FinancialInstitution();
  });
  ...
  describe('FinancialInstitution', function() {
    it('should create an instance of FinancialInstitution', function() {
      // uncomment below and update the code to test FinancialInstitution
      //var instane = new WealthsimpleApi.FinancialInstitution();
      //expect(instance).to.be.a(WealthsimpleApi.FinancialInstitution);
    });
    ...
    it('should have the property parentInstitution (base name: "parent_institution")', function() {
      // uncomment below and update the code to test the property parentInstitution
      //var instane = new WealthsimpleApi.FinancialInstitution();
      //expect(instance).to.be();
    });
    ...
    it('should have the property accountNumberFormat (base name: "account_number_format")', function() {
      // uncomment below and update the code to test the property accountNumberFormat
      //var instane = new WealthsimpleApi.FinancialInstitution();
      //expect(instance).to.be();
    });

    it('should have the property institutionNumber (base name: "institution_number")', function() {
