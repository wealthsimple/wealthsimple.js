...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.BankAccountBase();
  });
  ...
  describe('BankAccountBase', function() {
    it('should create an instance of BankAccountBase', function() {
      // uncomment below and update the code to test BankAccountBase
      //var instane = new WealthsimpleApi.BankAccountBase();
      //expect(instance).to.be.a(WealthsimpleApi.BankAccountBase);
    });
    ...
    it('should have the property jursidiction (base name: "jursidiction")', function() {
      // uncomment below and update the code to test the property jursidiction
      //var instane = new WealthsimpleApi.BankAccountBase();
      //expect(instance).to.be();
    });
    ...
    it('should have the property udpatedAt (base name: "udpated_at")', function() {
      // uncomment below and update the code to test the property udpatedAt
      //var instane = new WealthsimpleApi.BankAccountBase();
      //expect(instance).to.be();
    });
