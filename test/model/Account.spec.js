...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.Account();
  });
  ...
  describe('Account', function() {
    it('should create an instance of Account', function() {
      ...
      //var instane = new WealthsimpleApi.Account();
      //expect(instance).to.be.a(WealthsimpleApi.Account);
    });
    ...
    it('should have the property netLiquidation (base name: "net_liquidation")', function() {
      // uncomment below and update the code to test the property netLiquidation
      //var instane = new WealthsimpleApi.Account();
      //expect(instance).to.be();
    });

    it('should have the property grossPosition (base name: "gross_position")', function() {
      // uncomment below and update the code to test the property grossPosition
      //var instane = new WealthsimpleApi.Account();
      //expect(instance).to.be();
    });
