...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.Position();
  });
  ...
  describe('Position', function() {
    it('should create an instance of Position', function() {
      ...
      //var instane = new WealthsimpleApi.Position();
      //expect(instance).to.be.a(WealthsimpleApi.Position);
    });
    ...
    it('should have the property positionDate (base name: "position_date")', function() {
      // uncomment below and update the code to test the property positionDate
      //var instane = new WealthsimpleApi.Position();
      //expect(instance).to.be();
    });
