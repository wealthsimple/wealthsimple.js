...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.EmailPreferences();
  });
  ...
  describe('EmailPreferences', function() {
    it('should create an instance of EmailPreferences', function() {
      ...
      //var instane = new WealthsimpleApi.EmailPreferences();
      //expect(instance).to.be.a(WealthsimpleApi.EmailPreferences);
    });
    ...
    it('should have the property newsAndAnnouncements (base name: "news_and_announcements")', function() {
      // uncomment below and update the code to test the property newsAndAnnouncements
      //var instane = new WealthsimpleApi.EmailPreferences();
      //expect(instance).to.be();
    });

    it('should have the property corporateActions (base name: "corporate_actions")', function() {
      // uncomment below and update the code to test the property corporateActions
      //var instane = new WealthsimpleApi.EmailPreferences();
      //expect(instance).to.be();
    });
    ...
    it('should have the property tradeConfirms (base name: "trade_confirms")', function() {
      // uncomment below and update the code to test the property tradeConfirms
      //var instane = new WealthsimpleApi.EmailPreferences();
      //expect(instance).to.be();
    });

    it('should have the property taxStatements (base name: "tax_statements")', function() {
      // uncomment below and update the code to test the property taxStatements
      //var instane = new WealthsimpleApi.EmailPreferences();
      //expect(instance).to.be();
    });

    it('should have the property disclosures (base name: "disclosures")', function() {
      // uncomment below and update the code to test the property disclosures
      //var instane = new WealthsimpleApi.EmailPreferences();
      //expect(instance).to.be();
    });

    it('should have the property dailyStatements (base name: "daily_statements")', function() {
      // uncomment below and update the code to test the property dailyStatements
      //var instane = new WealthsimpleApi.EmailPreferences();
      //expect(instance).to.be();
    });

    it('should have the property monthlyStatements (base name: "monthly_statements")', function() {
      // uncomment below and update the code to test the property monthlyStatements
      //var instane = new WealthsimpleApi.EmailPreferences();
      //expect(instance).to.be();
    });
