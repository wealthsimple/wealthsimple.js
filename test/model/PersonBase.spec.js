...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.PersonBase();
  });
  ...
  describe('PersonBase', function() {
    it('should create an instance of PersonBase', function() {
      // uncomment below and update the code to test PersonBase
      //var instane = new WealthsimpleApi.PersonBase();
      //expect(instance).to.be.a(WealthsimpleApi.PersonBase);
    });

    it('should have the property preferredFirstName (base name: "preferred_first_name")', function() {
      // uncomment below and update the code to test the property preferredFirstName
      //var instane = new WealthsimpleApi.PersonBase();
      //expect(instance).to.be();
    });

    it('should have the property fullLegalName (base name: "full_legal_name")', function() {
      // uncomment below and update the code to test the property fullLegalName
      //var instane = new WealthsimpleApi.PersonBase();
      //expect(instance).to.be();
    });
    ...
    it('should have the property citizenships (base name: "citizenships")', function() {
      // uncomment below and update the code to test the property citizenships
      //var instane = new WealthsimpleApi.PersonBase();
      //expect(instance).to.be();
    });
    ...
    it('should have the property spouseOrCommonLaw (base name: "spouse_or_common_law")', function() {
      // uncomment below and update the code to test the property spouseOrCommonLaw
      //var instane = new WealthsimpleApi.PersonBase();
      //expect(instance).to.be();
    });

    it('should have the property taxIdentificationNumbers (base name: "tax_identification_numbers")', function() {
      // uncomment below and update the code to test the property taxIdentificationNumbers
      //var instane = new WealthsimpleApi.PersonBase();
      //expect(instance).to.be();
    });
    ...
    it('should have the property powerOfAttorney (base name: "power_of_attorney")', function() {
      // uncomment below and update the code to test the property powerOfAttorney
      //var instane = new WealthsimpleApi.PersonBase();
      //expect(instance).to.be();
    });
    ...
    it('should have the property regulatedPeople (base name: "regulated_people")', function() {
      // uncomment below and update the code to test the property regulatedPeople
      //var instane = new WealthsimpleApi.PersonBase();
      //expect(instance).to.be();
    });
    ...
    it('should have the property insiders (base name: "insiders")', function() {
      // uncomment below and update the code to test the property insiders
      //var instane = new WealthsimpleApi.PersonBase();
      //expect(instance).to.be();
    });
