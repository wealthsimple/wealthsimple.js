...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.DailyValue();
  });
  ...
  describe('DailyValue', function() {
    it('should create an instance of DailyValue', function() {
      // uncomment below and update the code to test DailyValue
      //var instane = new WealthsimpleApi.DailyValue();
      //expect(instance).to.be.a(WealthsimpleApi.DailyValue);
    });
    ...
    it('should have the property netLiquidationValue (base name: "net_liquidation_value")', function() {
      // uncomment below and update the code to test the property netLiquidationValue
      //var instane = new WealthsimpleApi.DailyValue();
      //expect(instance).to.be();
    });

    it('should have the property equityValue (base name: "equity_value")', function() {
      // uncomment below and update the code to test the property equityValue
      //var instane = new WealthsimpleApi.DailyValue();
      //expect(instance).to.be();
    });

    it('should have the property totalDeposits (base name: "total_deposits")', function() {
      // uncomment below and update the code to test the property totalDeposits
      //var instane = new WealthsimpleApi.DailyValue();
      //expect(instance).to.be();
    });
