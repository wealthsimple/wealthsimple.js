...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.AccountTransfer();
  });
  ...
  describe('AccountTransfer', function() {
    it('should create an instance of AccountTransfer', function() {
      // uncomment below and update the code to test AccountTransfer
      //var instane = new WealthsimpleApi.AccountTransfer();
      //expect(instance).to.be.a(WealthsimpleApi.AccountTransfer);
    });
    ...
    it('should have the property relinquishingInstitution (base name: "relinquishing_institution")', function() {
      // uncomment below and update the code to test the property relinquishingInstitution
      //var instane = new WealthsimpleApi.AccountTransfer();
      //expect(instance).to.be();
    });
