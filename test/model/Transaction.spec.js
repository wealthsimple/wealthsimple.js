...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.Transaction();
  });
  ...
  describe('Transaction', function() {
    it('should create an instance of Transaction', function() {
      ...
      //var instane = new WealthsimpleApi.Transaction();
      //expect(instance).to.be.a(WealthsimpleApi.Transaction);
    });
    ...
    it('should have the property bookValue (base name: "book_value")', function() {
      // uncomment below and update the code to test the property bookValue
      //var instane = new WealthsimpleApi.Transaction();
      //expect(instance).to.be();
    });

    it('should have the property adjustedBookValue (base name: "adjusted_book_value")', function() {
      // uncomment below and update the code to test the property adjustedBookValue
      //var instane = new WealthsimpleApi.Transaction();
      //expect(instance).to.be();
    });

    it('should have the property netCash (base name: "net_cash")', function() {
      // uncomment below and update the code to test the property netCash
      //var instane = new WealthsimpleApi.Transaction();
      //expect(instance).to.be();
    });

    it('should have the property contributionValue (base name: "contribution_value")', function() {
      // uncomment below and update the code to test the property contributionValue
      //var instane = new WealthsimpleApi.Transaction();
      //expect(instance).to.be();
    });

    it('should have the property processDate (base name: "process_date")', function() {
