...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.ClientBase();
  });
  ...
  describe('ClientBase', function() {
    it('should create an instance of ClientBase', function() {
      // uncomment below and update the code to test ClientBase
      //var instane = new WealthsimpleApi.ClientBase();
      //expect(instance).to.be.a(WealthsimpleApi.ClientBase);
    });
