...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.FundsTransferBase();
  });
  ...
  describe('FundsTransferBase', function() {
    it('should create an instance of FundsTransferBase', function() {
      // uncomment below and update the code to test FundsTransferBase
      //var instane = new WealthsimpleApi.FundsTransferBase();
      //expect(instance).to.be.a(WealthsimpleApi.FundsTransferBase);
    });
    ...
    it('should have the property postDated (base name: "post_dated")', function() {
      // uncomment below and update the code to test the property postDated
      //var instane = new WealthsimpleApi.FundsTransferBase();
      //expect(instance).to.be();
    });
