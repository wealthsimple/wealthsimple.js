...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new WealthsimpleApi.Assessment();
  });
  ...
  describe('Assessment', function() {
    it('should create an instance of Assessment', function() {
      ...
      //var instane = new WealthsimpleApi.Assessment();
      //expect(instance).to.be.a(WealthsimpleApi.Assessment);
    });
    ...
    it('should have the property creatorFullName (base name: "creator_full_name")', function() {
