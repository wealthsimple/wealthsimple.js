...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.DepositsPaginated = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Paginated);
  }
  ...
  /**
   * The DepositsPaginated model module.
   * @module model/DepositsPaginated
   * @version 1.0
   */

  /**
   * Constructs a new <code>DepositsPaginated</code>.
   * @alias module:model/DepositsPaginated
   * @class
  ...
  /**
   * Constructs a <code>DepositsPaginated</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DepositsPaginated} obj Optional instance to populate.
   * @return {module:model/DepositsPaginated} The populated <code>DepositsPaginated</code> instance.
   */
