...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.SurveysPaginated = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Paginated);
  }
  ...
  /**
   * The SurveysPaginated model module.
   * @module model/SurveysPaginated
   * @version 1.0
   */

  /**
   * Constructs a new <code>SurveysPaginated</code>.
   * @alias module:model/SurveysPaginated
   * @class
  ...
  /**
   * Constructs a <code>SurveysPaginated</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SurveysPaginated} obj Optional instance to populate.
   * @return {module:model/SurveysPaginated} The populated <code>SurveysPaginated</code> instance.
   */
