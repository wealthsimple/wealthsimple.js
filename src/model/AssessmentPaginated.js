...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.AssessmentPaginated = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Paginated);
  }
  ...
  /**
   * The AssessmentPaginated model module.
   * @module model/AssessmentPaginated
   * @version 1.0
   */

  /**
   * Constructs a new <code>AssessmentPaginated</code>.
   * @alias module:model/AssessmentPaginated
   * @class
  ...
  /**
   * Constructs a <code>AssessmentPaginated</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AssessmentPaginated} obj Optional instance to populate.
   * @return {module:model/AssessmentPaginated} The populated <code>AssessmentPaginated</code> instance.
   */
