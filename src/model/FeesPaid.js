...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.FeesPaid = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The FeesPaid model module.
   * @module model/FeesPaid
   * @version 1.0
   */

  /**
   * Constructs a new <code>FeesPaid</code>.
   * @alias module:model/FeesPaid
   * @class
  ...
  /**
   * Constructs a <code>FeesPaid</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FeesPaid} obj Optional instance to populate.
   * @return {module:model/FeesPaid} The populated <code>FeesPaid</code> instance.
   */
