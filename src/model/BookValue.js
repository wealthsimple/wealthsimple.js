...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.BookValue = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The BookValue model module.
   * @module model/BookValue
   * @version 1.0
   */

  /**
   * Constructs a new <code>BookValue</code>.
   * @alias module:model/BookValue
   * @class
  ...
  /**
   * Constructs a <code>BookValue</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BookValue} obj Optional instance to populate.
   * @return {module:model/BookValue} The populated <code>BookValue</code> instance.
   */
