...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.PeoplePaginated = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Paginated);
  }
  ...
  /**
   * The PeoplePaginated model module.
   * @module model/PeoplePaginated
   * @version 1.0
   */

  /**
   * Constructs a new <code>PeoplePaginated</code>.
   * @alias module:model/PeoplePaginated
   * @class
  ...
  /**
   * Constructs a <code>PeoplePaginated</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PeoplePaginated} obj Optional instance to populate.
   * @return {module:model/PeoplePaginated} The populated <code>PeoplePaginated</code> instance.
   */
