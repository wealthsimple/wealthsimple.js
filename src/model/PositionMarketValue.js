...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.PositionMarketValue = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The PositionMarketValue model module.
   * @module model/PositionMarketValue
   * @version 1.0
   */

  /**
   * Constructs a new <code>PositionMarketValue</code>.
   * @alias module:model/PositionMarketValue
   * @class
  ...
  /**
   * Constructs a <code>PositionMarketValue</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PositionMarketValue} obj Optional instance to populate.
   * @return {module:model/PositionMarketValue} The populated <code>PositionMarketValue</code> instance.
   */
