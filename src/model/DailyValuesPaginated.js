...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.DailyValuesPaginated = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Paginated);
  }
  ...
  /**
   * The DailyValuesPaginated model module.
   * @module model/DailyValuesPaginated
   * @version 1.0
   */

  /**
   * Constructs a new <code>DailyValuesPaginated</code>.
   * @alias module:model/DailyValuesPaginated
   * @class
  ...
  /**
   * Constructs a <code>DailyValuesPaginated</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DailyValuesPaginated} obj Optional instance to populate.
   * @return {module:model/DailyValuesPaginated} The populated <code>DailyValuesPaginated</code> instance.
   */
