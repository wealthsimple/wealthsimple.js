...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.AccountTransfersPaginated = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Paginated);
  }
  ...
  /**
   * The AccountTransfersPaginated model module.
   * @module model/AccountTransfersPaginated
   * @version 1.0
   */

  /**
   * Constructs a new <code>AccountTransfersPaginated</code>.
   * @alias module:model/AccountTransfersPaginated
   * @class
  ...
  /**
   * Constructs a <code>AccountTransfersPaginated</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccountTransfersPaginated} obj Optional instance to populate.
   * @return {module:model/AccountTransfersPaginated} The populated <code>AccountTransfersPaginated</code> instance.
   */
