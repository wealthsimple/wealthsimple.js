...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.EquityValue = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The EquityValue model module.
   * @module model/EquityValue
   * @version 1.0
   */

  /**
   * Constructs a new <code>EquityValue</code>.
   * @alias module:model/EquityValue
   * @class
  ...
  /**
   * Constructs a <code>EquityValue</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EquityValue} obj Optional instance to populate.
   * @return {module:model/EquityValue} The populated <code>EquityValue</code> instance.
   */
