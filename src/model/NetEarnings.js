...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.NetEarnings = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The NetEarnings model module.
   * @module model/NetEarnings
   * @version 1.0
   */

  /**
   * Constructs a new <code>NetEarnings</code>.
   * @alias module:model/NetEarnings
   * @class
  ...
  /**
   * Constructs a <code>NetEarnings</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NetEarnings} obj Optional instance to populate.
   * @return {module:model/NetEarnings} The populated <code>NetEarnings</code> instance.
   */
