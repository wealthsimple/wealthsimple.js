...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.Person = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Address, root.WealthsimpleApi.Citizenships, root.WealthsimpleApi.CountryCode, root.WealthsimpleApi.CreatedAt, root.WealthsimpleApi.CreatedUpdatedAt, root.WealthsimpleApi.Dependents, root.WealthsimpleApi.Email, root.WealthsimpleApi.Employment, root.WealthsimpleApi.ExternalId, root.WealthsimpleApi.FullLegalName, root.WealthsimpleApi.Gender, root.WealthsimpleApi.Insiders, root.WealthsimpleApi.Locale, root.WealthsimpleApi.MaritalStatus, root.WealthsimpleApi.Name, root.WealthsimpleApi.PersonBase, root.WealthsimpleApi.PersonId, root.WealthsimpleApi.PhoneNumbers, root.WealthsimpleApi.PoliticallyExposedPeople, root.WealthsimpleApi.PreferredFirstName, root.WealthsimpleApi.RegulatedPeople, root.WealthsimpleApi.SpouseOrCommonLaw, root.WealthsimpleApi.TaxIdentificationNumbers, root.WealthsimpleApi.UpdatedAt, root.WealthsimpleApi.UserId);
  }
