...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Wealthsimple.CorporationUpdate = factory(root.Wealthsimple.ApiClient, root.Wealthsimple.Address, root.Wealthsimple.CorporationBase, root.Wealthsimple.CorporationDirectors, root.Wealthsimple.CorporationName, root.Wealthsimple.CorporationOwners, root.Wealthsimple.CountryCode, root.Wealthsimple.Email, root.Wealthsimple.ExternalId, root.Wealthsimple.Locale, root.Wealthsimple.PhoneNumbers, root.Wealthsimple.TaxIdentification, root.Wealthsimple.UserId);
  }
  ...
  /**
   * The CorporationUpdate model module.
   * @module model/CorporationUpdate
   * @version 1.0
   */

  /**
   * Constructs a new <code>CorporationUpdate</code>.
   * @alias module:model/CorporationUpdate
   * @class
  ...
  /**
   * Constructs a <code>CorporationUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CorporationUpdate} obj Optional instance to populate.
   * @return {module:model/CorporationUpdate} The populated <code>CorporationUpdate</code> instance.
   */
