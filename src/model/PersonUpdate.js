...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.PersonUpdate = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Address, root.WealthsimpleApi.Citizenships, root.WealthsimpleApi.CountryCode, root.WealthsimpleApi.Dependents, root.WealthsimpleApi.Email, root.WealthsimpleApi.Employment, root.WealthsimpleApi.ExternalId, root.WealthsimpleApi.FullLegalName, root.WealthsimpleApi.Gender, root.WealthsimpleApi.Insiders, root.WealthsimpleApi.Locale, root.WealthsimpleApi.MaritalStatus, root.WealthsimpleApi.Name, root.WealthsimpleApi.PersonBase, root.WealthsimpleApi.PhoneNumbers, root.WealthsimpleApi.PoliticallyExposedPeople, root.WealthsimpleApi.PreferredFirstName, root.WealthsimpleApi.RegulatedPeople, root.WealthsimpleApi.SpouseOrCommonLaw, root.WealthsimpleApi.TaxIdentificationNumbers, root.WealthsimpleApi.UserId);
  }
  ...
  /**
   * The PersonUpdate model module.
   * @module model/PersonUpdate
   * @version 1.0
   */

  /**
   * Constructs a new <code>PersonUpdate</code>.
   * @alias module:model/PersonUpdate
   * @class
  ...
  /**
   * Constructs a <code>PersonUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PersonUpdate} obj Optional instance to populate.
   * @return {module:model/PersonUpdate} The populated <code>PersonUpdate</code> instance.
   */
