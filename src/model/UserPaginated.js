...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.UserPaginated = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Paginated);
  }
  ...
  /**
   * The UserPaginated model module.
   * @module model/UserPaginated
   * @version 1.0
   */

  /**
   * Constructs a new <code>UserPaginated</code>.
   * @alias module:model/UserPaginated
   * @class
  ...
  /**
   * Constructs a <code>UserPaginated</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UserPaginated} obj Optional instance to populate.
   * @return {module:model/UserPaginated} The populated <code>UserPaginated</code> instance.
   */
