...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.TotalDeposits = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The TotalDeposits model module.
   * @module model/TotalDeposits
   * @version 1.0
   */

  /**
   * Constructs a new <code>TotalDeposits</code>.
   * @alias module:model/TotalDeposits
   * @class
  ...
  /**
   * Constructs a <code>TotalDeposits</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TotalDeposits} obj Optional instance to populate.
   * @return {module:model/TotalDeposits} The populated <code>TotalDeposits</code> instance.
   */
