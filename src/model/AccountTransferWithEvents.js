...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountId', 'model/AccountTransfer', 'model/AccountTransferEvent', 'model/AccountTransferId', 'model/Institution'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccountId'), require('./AccountTransfer'), require('./AccountTransferEvent'), require('./AccountTransferId'), require('./Institution'));
  } else {
    // Browser globals (root is window)
    if (!root.WealthsimpleApi) {
      root.WealthsimpleApi = {};
    }
    root.WealthsimpleApi.AccountTransferWithEvents = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.AccountId, root.WealthsimpleApi.AccountTransfer, root.WealthsimpleApi.AccountTransferEvent, root.WealthsimpleApi.AccountTransferId, root.WealthsimpleApi.Institution);
  }
}(this, function(ApiClient, AccountId, AccountTransfer, AccountTransferEvent, AccountTransferId, Institution) {
  'use strict';
  ...
  /**
   * The AccountTransferWithEvents model module.
   * @module model/AccountTransferWithEvents
   * @version 1.0
   */

  /**
   * Constructs a new <code>AccountTransferWithEvents</code>.
   * @alias module:model/AccountTransferWithEvents
   * @class
   * @implements module:model/AccountTransfer
   */
  var exports = function() {
    var _this = this;

    AccountTransfer.call(_this);

  };

  /**
   * Constructs a <code>AccountTransferWithEvents</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccountTransferWithEvents} obj Optional instance to populate.
   * @return {module:model/AccountTransferWithEvents} The populated <code>AccountTransferWithEvents</code> instance.
   */
  ...
  /**
   * @member {Array.<module:model/AccountTransferEvent>} events
   */
  exports.prototype['events'] = undefined;

  // Implement AccountTransfer interface:
  /**
