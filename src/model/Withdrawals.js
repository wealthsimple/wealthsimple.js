...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.Withdrawals = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The Withdrawals model module.
   * @module model/Withdrawals
   * @version 1.0
   */

  /**
   * Constructs a new <code>Withdrawals</code>.
   * @alias module:model/Withdrawals
   * @class
  ...
  /**
   * Constructs a <code>Withdrawals</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Withdrawals} obj Optional instance to populate.
   * @return {module:model/Withdrawals} The populated <code>Withdrawals</code> instance.
   */
