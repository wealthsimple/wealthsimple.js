...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.TrustUpdate = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Address, root.WealthsimpleApi.CountryCode, root.WealthsimpleApi.Email, root.WealthsimpleApi.ExternalId, root.WealthsimpleApi.Locale, root.WealthsimpleApi.PhoneNumbers, root.WealthsimpleApi.TaxIdentification, root.WealthsimpleApi.TrustBase, root.WealthsimpleApi.TrustName, root.WealthsimpleApi.UserId);
  }
  ...
  /**
   * The TrustUpdate model module.
   * @module model/TrustUpdate
   * @version 1.0
   */

  /**
   * Constructs a new <code>TrustUpdate</code>.
   * @alias module:model/TrustUpdate
   * @class
  ...
  /**
   * Constructs a <code>TrustUpdate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TrustUpdate} obj Optional instance to populate.
   * @return {module:model/TrustUpdate} The populated <code>TrustUpdate</code> instance.
   */
