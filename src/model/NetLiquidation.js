...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.NetLiquidation = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The NetLiquidation model module.
   * @module model/NetLiquidation
   * @version 1.0
   */

  /**
   * Constructs a new <code>NetLiquidation</code>.
   * @alias module:model/NetLiquidation
   * @class
  ...
  /**
   * Constructs a <code>NetLiquidation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NetLiquidation} obj Optional instance to populate.
   * @return {module:model/NetLiquidation} The populated <code>NetLiquidation</code> instance.
   */
