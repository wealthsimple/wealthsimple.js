...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.BankAccountsPaginated = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Paginated);
  }
  ...
  /**
   * The BankAccountsPaginated model module.
   * @module model/BankAccountsPaginated
   * @version 1.0
   */

  /**
   * Constructs a new <code>BankAccountsPaginated</code>.
   * @alias module:model/BankAccountsPaginated
   * @class
  ...
  /**
   * Constructs a <code>BankAccountsPaginated</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BankAccountsPaginated} obj Optional instance to populate.
   * @return {module:model/BankAccountsPaginated} The populated <code>BankAccountsPaginated</code> instance.
   */
