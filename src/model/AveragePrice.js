...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.AveragePrice = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The AveragePrice model module.
   * @module model/AveragePrice
   * @version 1.0
   */

  /**
   * Constructs a new <code>AveragePrice</code>.
   * @alias module:model/AveragePrice
   * @class
  ...
  /**
   * Constructs a <code>AveragePrice</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AveragePrice} obj Optional instance to populate.
   * @return {module:model/AveragePrice} The populated <code>AveragePrice</code> instance.
   */
