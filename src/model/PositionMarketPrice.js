...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.PositionMarketPrice = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The PositionMarketPrice model module.
   * @module model/PositionMarketPrice
   * @version 1.0
   */

  /**
   * Constructs a new <code>PositionMarketPrice</code>.
   * @alias module:model/PositionMarketPrice
   * @class
  ...
  /**
   * Constructs a <code>PositionMarketPrice</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PositionMarketPrice} obj Optional instance to populate.
   * @return {module:model/PositionMarketPrice} The populated <code>PositionMarketPrice</code> instance.
   */
