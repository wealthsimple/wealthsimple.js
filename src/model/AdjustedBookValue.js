...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.AdjustedBookValue = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The AdjustedBookValue model module.
   * @module model/AdjustedBookValue
   * @version 1.0
   */

  /**
   * Constructs a new <code>AdjustedBookValue</code>.
   * @alias module:model/AdjustedBookValue
   * @class
  ...
  /**
   * Constructs a <code>AdjustedBookValue</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AdjustedBookValue} obj Optional instance to populate.
   * @return {module:model/AdjustedBookValue} The populated <code>AdjustedBookValue</code> instance.
   */
