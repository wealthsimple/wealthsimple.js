...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.AccountsPaginated = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Paginated);
  }
  ...
  /**
   * The AccountsPaginated model module.
   * @module model/AccountsPaginated
   * @version 1.0
   */

  /**
   * Constructs a new <code>AccountsPaginated</code>.
   * @alias module:model/AccountsPaginated
   * @class
  ...
  /**
   * Constructs a <code>AccountsPaginated</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccountsPaginated} obj Optional instance to populate.
   * @return {module:model/AccountsPaginated} The populated <code>AccountsPaginated</code> instance.
   */
