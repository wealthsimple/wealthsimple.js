...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.MarketPrice = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The MarketPrice model module.
   * @module model/MarketPrice
   * @version 1.0
   */

  /**
   * Constructs a new <code>MarketPrice</code>.
   * @alias module:model/MarketPrice
   * @class
  ...
  /**
   * Constructs a <code>MarketPrice</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MarketPrice} obj Optional instance to populate.
   * @return {module:model/MarketPrice} The populated <code>MarketPrice</code> instance.
   */
