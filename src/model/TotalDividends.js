...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.TotalDividends = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The TotalDividends model module.
   * @module model/TotalDividends
   * @version 1.0
   */

  /**
   * Constructs a new <code>TotalDividends</code>.
   * @alias module:model/TotalDividends
   * @class
  ...
  /**
   * Constructs a <code>TotalDividends</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TotalDividends} obj Optional instance to populate.
   * @return {module:model/TotalDividends} The populated <code>TotalDividends</code> instance.
   */
