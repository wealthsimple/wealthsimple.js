...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.DebitBankAccountsPaginated = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Paginated);
  }
  ...
  /**
   * The DebitBankAccountsPaginated model module.
   * @module model/DebitBankAccountsPaginated
   * @version 1.0
   */

  /**
   * Constructs a new <code>DebitBankAccountsPaginated</code>.
   * @alias module:model/DebitBankAccountsPaginated
   * @class
  ...
  /**
   * Constructs a <code>DebitBankAccountsPaginated</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DebitBankAccountsPaginated} obj Optional instance to populate.
   * @return {module:model/DebitBankAccountsPaginated} The populated <code>DebitBankAccountsPaginated</code> instance.
   */
