...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.NetCash = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The NetCash model module.
   * @module model/NetCash
   * @version 1.0
   */

  /**
   * Constructs a new <code>NetCash</code>.
   * @alias module:model/NetCash
   * @class
  ...
  /**
   * Constructs a <code>NetCash</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NetCash} obj Optional instance to populate.
   * @return {module:model/NetCash} The populated <code>NetCash</code> instance.
   */
