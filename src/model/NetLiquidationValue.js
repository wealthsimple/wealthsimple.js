...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.NetLiquidationValue = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Currency, root.WealthsimpleApi.Money);
  }
  ...
  /**
   * The NetLiquidationValue model module.
   * @module model/NetLiquidationValue
   * @version 1.0
   */

  /**
   * Constructs a new <code>NetLiquidationValue</code>.
   * @alias module:model/NetLiquidationValue
   * @class
  ...
  /**
   * Constructs a <code>NetLiquidationValue</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NetLiquidationValue} obj Optional instance to populate.
   * @return {module:model/NetLiquidationValue} The populated <code>NetLiquidationValue</code> instance.
   */
