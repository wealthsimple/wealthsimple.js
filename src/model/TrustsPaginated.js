...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.WealthsimpleApi.TrustsPaginated = factory(root.WealthsimpleApi.ApiClient, root.WealthsimpleApi.Paginated);
  }
  ...
  /**
   * The TrustsPaginated model module.
   * @module model/TrustsPaginated
   * @version 1.0
   */

  /**
   * Constructs a new <code>TrustsPaginated</code>.
   * @alias module:model/TrustsPaginated
   * @class
  ...
  /**
   * Constructs a <code>TrustsPaginated</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TrustsPaginated} obj Optional instance to populate.
   * @return {module:model/TrustsPaginated} The populated <code>TrustsPaginated</code> instance.
   */
