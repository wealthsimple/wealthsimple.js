...
(function(factory) {
   ...
   * <pre>
   * var WealthsimpleApi = require('index'); // See note below*.
   * var xxxSvc = new WealthsimpleApi.XxxApi(); // Allocate the API class we're going to use.
   * var yyyModel = new WealthsimpleApi.Yyy(); // Construct a model instance.
   ...
   * <pre>
   * var xxxSvc = new WealthsimpleApi.XxxApi(); // Allocate the API class we're going to use.
   * var yyy = new WealthsimpleApi.Yyy(); // Construct a model instance.
   * yyyModel.someProperty = 'someValue';
   * ...
   * var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
   * ...
